...
<head>
<meta charset="utf-8">
<title>Trang tìm kiếm trang phục theo TÊN SKIN</title>
	 ...
	 <div class="container">				
		<div class="row">
					<script type="text/javascript">
						...
						<p class="font-weight-bold text-dark display-4 col-md-12 text-center"> Trang tìm kiếm trang phục theo <b class="text-danger">TÊN SKIN </b> </p>
						<form class="col-md-12 text-center" method="get" id="form_search" action="xldn.php">
                        <input class="form-control text-success font-weight-bold" type="text" name="key" id="key"  placeholder="Nhập tên Trang phục bạn muốn tìm kiếm" />
                        </br>
